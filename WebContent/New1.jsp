...
<div align="center"> 
 <div class="inputwrap5">
 <input type="checkbox" id="cb1" name="cb" value=""> <label for="cb3">Test6 hello watsup wat doing</label>
 </div>
   <div class="inputwrap5">
 <input type="checkbox" id="cb2" name="cb" value=""> <label for="cb2">Test6 how r u</label> 
 </div>
  <div class="inputwrap5">
 <input type="checkbox" id="cb3" name="cb" value=""> <label for="cb1">Test6 i am fine</label> 
  </div>
</div> 
</span>
